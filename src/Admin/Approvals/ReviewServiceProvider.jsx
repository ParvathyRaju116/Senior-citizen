...
const ReviewServiceProvider = ({ item }) => {
  ...
  const DrawerList = (
    ...
    <Box sx={{ width: 300 }} role="presentation" onClick={toggleDrawer(false)}>
      <div className="drawer-header">
        <h3 className="drawer-header-text p-2">Reviews</h3>
      ...
      <List>
        {reviews.length>0 ?  reviews.map((review, index) => (
          <div key={review._id}>
            ...
            <h3 className="text-center text-danger" style={{alignItems:"center"}}>No reviews added</h3>
            </div>}
      </List>
    </Box>
    </div>
