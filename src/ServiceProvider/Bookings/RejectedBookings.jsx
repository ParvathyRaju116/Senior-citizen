  ...
  return (
    <div>
     ...
     <div className='row'>
          {rejected?.length > 0 ? (
            rejected.map((item) => (
              <div className="card2 card col-md-4 mt-5 text-center shadow m-3" style={{ width: '18rem', backgroundColor: '' }} key={item.id}>
                <ul className="list-group list-group-light list-group-small">
                <li className="list-group-item px-3">Username: {item.userName.toUpperCase()}</li>
